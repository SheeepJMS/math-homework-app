...
def upgrade():
    ...
    op.create_table('diag_question_answers',
    ...
    op.create_table('diag_question_kp',
        sa.Column('exam_id', sa.Integer(), nullable=False),
        sa.Column('q_index', sa.Integer(), nullable=False),
    ...
    op.create_table('diag_question_practice_items',
    ...
    op.create_index('ix_diag_question_practice_items_exam_q', 'diag_question_practice_items', ['exam_id', 'q_index'])

    # 4) 每题默认练习数量（CSV 可覆盖）
    op.create_table('diag_exam_question_practice_config',
        sa.Column('exam_id', sa.Integer(), nullable=False),
        sa.Column('q_index', sa.Integer(), nullable=False),
